...
INSERT OR IGNORE INTO system_config (key, value, category) VALUES
    ...
    ('qa.max_retries',            '3',             'qa'),
    ('qa.min_length',             '900',           'qa'),
    ('qa.max_length',             '5000',          'qa'),
    ('qa.duplicate_threshold',    '0.85',          'qa'),
    ('qa.opening_similarity_threshold', '0.85',    'qa'),
    ('qa.required_language',      'zh',            'qa'),
    ('qa.required_perspective',   'first_person',  'qa'),
...
CREATE TABLE IF NOT EXISTS sensory_snapshots (
    ...
    io_read_delta_bytes INTEGER,
    io_write_delta_bytes INTEGER,
    io_read_bytes_per_sec REAL,
    io_write_bytes_per_sec REAL,
    disk_usage_percent  REAL,
    network_rx_bytes    INTEGER,
    network_tx_bytes    INTEGER,
    network_rx_delta_bytes INTEGER,
    network_tx_delta_bytes INTEGER,
