...
KNOWN_AUDIT_EVENTS = [
    ...
    {"action": "config.reveal_secret", "display_name": "查看敏感配置", "target_label": "系统设置"},
    ...
    {"action": "ghost.delete_export", "display_name": "删除备份包", "target_label": "备份包"},
    {"action": "ghost.download_export", "display_name": "下载备份包", "target_label": "备份包"},
    {"action": "ghost.prune_exports", "display_name": "清理旧备份包", "target_label": "备份包"},
    {"action": "ghost.backup_database", "display_name": "备份数据库", "target_label": "数据库快照"},
    {"action": "ghost.download_database_backup", "display_name": "下载数据库快照", "target_label": "数据库快照"},
    {"action": "ghost.delete_database_backup", "display_name": "删除数据库快照", "target_label": "数据库快照"},
    {"action": "ghost.prune_database_backups", "display_name": "清理旧数据库快照", "target_label": "数据库快照"},
