...
class SensorySnapshot(Base):
    ...
    io_read_delta_bytes: Mapped[int | None] = mapped_column(Integer, nullable=True)
    io_write_delta_bytes: Mapped[int | None] = mapped_column(Integer, nullable=True)
    io_read_bytes_per_sec: Mapped[float | None] = mapped_column(Float, nullable=True)
    io_write_bytes_per_sec: Mapped[float | None] = mapped_column(Float, nullable=True)
    ...
    network_rx_delta_bytes: Mapped[int | None] = mapped_column(Integer, nullable=True)
    network_tx_delta_bytes: Mapped[int | None] = mapped_column(Integer, nullable=True)
    ...
    sample_interval_seconds: Mapped[float | None] = mapped_column(Float, nullable=True)
