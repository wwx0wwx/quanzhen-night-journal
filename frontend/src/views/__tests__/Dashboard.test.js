...
describe('Dashboard view', () => {
  ...
  it('renders failure reasons and publish decision hints', async () => {
    ...
    expect(wrapper.text()).toContain('该发布路径来自历史记录推断')
    expect(wrapper.text()).toContain('大脑接入')
    expect(wrapper.text()).toContain('今日模型费用')
    expect(wrapper.text()).toContain('系统健康与域名')
    expect(wrapper.text()).toContain('重新自检')
