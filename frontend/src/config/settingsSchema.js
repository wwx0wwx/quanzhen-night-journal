export const settingsSections = [
  ...
  },
  {
    id: 'backup',
    title: '自动备份',
    description: '按计划保存数据库快照，并自动清理旧的自动备份。',
    fields: [
      {
      ...
      {
        key: 'backup.include_ghost_weekly',
        label: '每周完整包',
        type: 'boolean',
        defaultValue: '0',
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        placeholder: '900',
        defaultValue: '900',
        help: '正文最小字符数。medium 夜记建议 800–1000，过短易沦为姿态速写。',
        min: 0,
        step: 1,
      },
      {
      ...
      {
        key: 'qa.opening_similarity_threshold',
        label: '开场相似度阈值',
        type: 'number',
        placeholder: '0.85',
        defaultValue: '0.85',
      ...
      {
        key: 'narrative.posts_per_world_year',
        label: '每年约几篇夜记',
        type: 'number',
        placeholder: '15',
        defaultValue: '15',
